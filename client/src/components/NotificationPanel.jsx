    ...
    const handleNotificationClick = async (notification) => {
        try {
            ...
            if (notification.action_url) {
                ...
                const path = notification.action_url.startsWith('/') ? notification.action_url : `/${notification.action_url}`;
                navigate(path);
            } else {
                // Enhanced navigation based on type - more Instagram-like
                switch (notification.type) {
                    ...
                    case 'mention':
                        ...
                        if (notification.related_post) {
                            if (notification.related_comment) {
                                navigate(`/feed?post=${notification.related_post}&comment=${notification.related_comment}`);
                            } else {
                                navigate(`/feed?post=${notification.related_post}`);
                            }
                        } else {
                            navigate('/feed');
                        }
                    ...
                    case 'group_post':
                    case 'group_message':
                        // Navigate to specific group if available
                        if (notification.metadata && notification.metadata.groupId) {
            ...
            console.error('Notification click error:', error, notification);
